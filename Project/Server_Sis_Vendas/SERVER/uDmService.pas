...
begin
   ...
   try
    ...
    qryInsere.CommandText.Add('INSERT INTO "PESSOA"(cod_pessoa,"NAME","CPF","CEP","ENDERECO","TIPO")');
    qryInsere.CommandText.Add('VALUES (:cod_pessoa,:NAME,:CPF,:CEP,:ENDERECO,:TIPO)');
    ...
    begin
      qryInsere.CommandText.Clear;
      qryInsere.CommandText.Add('INSERT INTO "CLIENTE"(cod_cliente, cod_pessoa,"CPF","NAME","STATUS")');
      qryInsere.CommandText.Add('VALUES (:cod_cliente, :cod_pessoa,:CPF,:NAME,''Ativo'')');
...
begin
   ...
   try
    ...
    qryDelete.CommandText.Add('DELETE FROM "PESSOA" WHERE "CPF" = :CPF');
...
begin
   try
    ...
    qryUpdate.CommandText.Clear;
    qryUpdate.CommandText.Add('UPDATE "CLIENTE" SET "NAME" = :NAME');
    qryUpdate.CommandText.Add('WHERE "CPF" = :CPF');
    qryUpdate.ParamByName('NAME').AsString     :=  Params.ItemsString['NAME'].AsString;
    qryUpdate.ParamByName('CPF').AsString      :=  Params.ItemsString['CPF'].AsString;
    qryUpdate.Execute();
...
begin
    ...
    begin
    qryDelete.CommandText.Clear;
    qryDelete.CommandText.Add('DELETE FROM "FORNECEDOR" WHERE "CNPJ" = :CNPJ');
...
begin
    ...
    qryInsere.CommandText.Clear;
    qryInsere.CommandText.Add('INSERT INTO "FORNECEDOR"(cod_fornecedor,"NOME_FANTA","CNPJ","RAZAO_SOCIAL","STATUS")');
    qryInsere.CommandText.Add('VALUES (:cod_fornecedor,:NOME_FANTA,:CNPJ,:RAZAO_SOCIAL,:STATUS)');
...
begin
  ...
  qryInsere.CommandText.Clear;
  qryInsere.CommandText.Add('INSERT INTO "USUARIO"(cod_usuario, cod_pessoa, "USUARIO", "SENHA","PERCADPESSOA","PERCADFORNECEDOR","PERCADPRODUTO","PERVENDAS" )');
  qryInsere.CommandText.Add('VALUES (:cod_usuario, :cod_pessoa, :USUARIO, :SENHA,:PERCADPESSOA,:PERCADFORNECEDOR,:PERCADPRODUTO,:PERVENDAS)');
...
begin
   ...
   try
    ...
    begin
    qryDelete.CommandText.Clear;
    qryDelete.CommandText.Add('DELETE FROM "PRODUTO" WHERE cod_produto = :COD_PRODUTO');
...
begin
   try
    ...
    qryInsere.CommandText.Clear;
    qryInsere.CommandText.Add('INSERT INTO "PRODUTO" (COD_PRODUTO,"DESCRICAO","PRECO",cod_fornecedor,status)');
    qryInsere.CommandText.Add('VALUES (:COD_PRODUTO,:DESCRICAO,:PRECO,:cod_fornecedor,:status)');
    ...
    qryInsere.ParamByName('PRECO').AsFloat            :=  StrToFloat(Params.ItemsString['VALOR'].AsString);
...
begin
   try
    ...
    begin
    qryUpdate.CommandText.Clear;
    qryUpdate.CommandText.Add('UPDATE "PRODUTO" SET "DESCRICAO" = :DESCRICAO, "PRECO" = :PRECO, STATUS = :STATUS');
    ...
    qryUpdate.ParamByName('PRECO').AsFloat            :=  StrToFloat(Params.ItemsString['VALOR'].AsString);
    qryUpdate.ParamByName('STATUS').AsString          :=  Params.ItemsString['STATUS'].AsString;
